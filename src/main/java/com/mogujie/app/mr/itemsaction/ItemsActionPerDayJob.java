...
public class ItemsActionPerDayJob {
	private static final String HDFS_URI = "hdfs://qihe2061:8020";
	private static final String JobName = "items_action";
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			job.setJarByClass(ItemsActionPerDayJob.class);
			job.setOutputKeyClass(Text.class);
			job.setOutputValueClass(BytesRefArrayWritable.class);
			job.setMapperClass(ItemsActionMapper.class);
			job.setOutputFormatClass(ItemsActionOutputFormat.class);
