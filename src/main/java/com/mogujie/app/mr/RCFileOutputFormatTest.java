 ...
 * @param <K>
 * @param <V>
 * @Date 2013-8-20 ä¸????2:02:02
 * 
 */
public class RCFileOutputFormatTest
		extends
		FileOutputFormat<WritableComparable<Writable>, BytesRefArrayWritable> {
	...
	@Override
	public RecordWriter<WritableComparable<Writable>, BytesRefArrayWritable> getRecordWriter(
		...
		return new RecordWriter<WritableComparable<Writable>, BytesRefArrayWritable>() {

			@Override
			public void write(WritableComparable<Writable> key,
