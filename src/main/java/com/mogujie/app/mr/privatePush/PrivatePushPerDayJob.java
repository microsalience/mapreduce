...
/**
 * @author xingtian
 * @version $Id: PrivatePushPerDayJob.java,v 0.1 2014年4月20日 下午2:59:59 xingtian
 *          Exp $
 */
public class PrivatePushPerDayJob {
	private static final String HDFS_URI = "hdfs://qihe2061:8020";
	private static final String JobName = "private_push";
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			job.setJarByClass(PrivatePushPerDayJob.class);
			job.setOutputKeyClass(Text.class);
			job.setOutputValueClass(BytesRefArrayWritable.class);
			job.setMapperClass(PrivatePushMapper.class);
			job.setOutputFormatClass(PrivatePushOutputFormat.class);
