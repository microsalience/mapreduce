...
/**
 * @author xingtian
 * @version $Id: BookLogMain.java,v 0.1 2014年5月23日 下午3:32:01 xingtian Exp $
 */
public class BookLogMain {
	private static final String HDFS_URI = "hdfs://qihe2061:8020";
	private static final String JobName = "book_log";
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			job.setJarByClass(BookLogMain.class);
			job.setOutputKeyClass(Text.class);
			job.setOutputValueClass(BytesRefArrayWritable.class);
			job.setMapperClass(BookLogMapper.class);
			job.setOutputFormatClass(BookLogOutputFormat.class);
