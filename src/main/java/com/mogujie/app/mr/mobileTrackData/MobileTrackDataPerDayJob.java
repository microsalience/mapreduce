...
/**
 * @author xingtian
 * @version $Id: MobileTrackDataPerDayJob.java,v 0.1 2014�?3???3??? �????5:16:52
 *          xingtian Exp $
 */
public class MobileTrackDataPerDayJob {
	private static final String HDFS_URI = "hdfs://qihe2061:8020";
	private static final String JobName = "mobile_track_data";
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			job.setJarByClass(MobileTrackDataPerDayJob.class);
			job.setOutputKeyClass(Text.class);
			job.setOutputValueClass(BytesRefArrayWritable.class);
			job.setMapperClass(MobileTrackDataMapper.class);
			job.setOutputFormatClass(MobileTrackDataOutputFormat.class);
