...
/**
 * @author xingtian
 * @version $Id: MobileTrackDevicePerDayJob.java,v 0.1 2014�?3???3???
 *          �????4:27:33 xingtian Exp $
 */
public class MobileTrackDevicePerDayJob {
	private static final String HDFS_URI = "hdfs://qihe2061:8020";
	private static final String JobName = "mobile_track_device";
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			job.setJarByClass(MobileTrackDevicePerDayJob.class);
			job.setOutputKeyClass(Text.class);
			job.setOutputValueClass(BytesRefArrayWritable.class);
			job.setMapperClass(MobileTrackDeviceMapper.class);
			job.setOutputFormatClass(MobileTrackDeviceOutputFormat.class);
