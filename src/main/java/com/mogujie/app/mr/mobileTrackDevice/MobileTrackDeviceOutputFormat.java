...
/**
 * @author xingtian
 * @version $Id: MobileTrackDeviceOutputFormat.java,v 0.1 2014å¹?3???3??? ä¸????4:28:18
 *          xingtian Exp $
 */
public class MobileTrackDeviceOutputFormat<K extends WritableComparable<?>, V extends Writable>
