 ...
 *
 * @author beifeng
 * @Date 2013-8-21 �????1:15:40
 *
 */
public class AccessLogOutputFormat<K extends WritableComparable<?>, V extends Writable> extends RCFileOutputFormat<K, V> {
	...
	protected String generateFileNameForKeyValue(K key, V value,
        ...
        String filename = dir.substring(0, index+1) + "visit_date=" + array[0] + "/visit_hour=" 
        				 + array[1] + "/" + name; 
