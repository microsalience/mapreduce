...
/**
 * @author yinxiu
 * @version $Id: NginxAccessCNjieJob.java,v 0.1 2013�?10???25??? �????1:47:42
 *          yinxiu Exp $
 */
public class NginxAccessCNjieJob {
	private static final String HDFS_URI = "hdfs://qihe2061:8020";
	private static final String Name = "nginx_access_cnjie";
	...
	public static void main(String[] args) {
		try {
			...
			Job job = new Job(c, "nginx_access_cnjie_job");
			job.setJarByClass(NginxAccessCNjieJob.class);
			job.setOutputKeyClass(Text.class);
			job.setOutputValueClass(BytesRefArrayWritable.class);
			job.setMapperClass(NginxAccessCNjieMapper.class);
			job.setOutputFormatClass(NginxAccessCNjieOutputFormat.class);
